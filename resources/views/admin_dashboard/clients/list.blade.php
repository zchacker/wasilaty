...
<div class="content">
    ...
    <h2 class="text-2xl font-bold mb-4"> العملاء </h2>
                ...
                <tbody class="table_body">
                    @foreach($users as $user)
                        <tr data-href="" class="clickable-row cursor-pointer hover:bg-gray-200">
                            ...
                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 text-right"> {{ $user->name }} </td>                            
                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 text-right" dir="ltr"> {{ $user->phone }} </td>                            
